...
- [ ] **B4** — Verrouillage concurrent des encaissements : empêcher deux versements simultanés de dépasser le reste dû (verrou sur l'inscription/ses versements dans une seule transaction).
  Référence : `services/versement_service.py`.
