...
from utils.list_printer import CantineStatPrinter
...
class StatCantineView(QWidget):
    ...
    def init_ui(self):
        ...
        titre = QLabel("État des Versements de Cantine")
        titre.setStyleSheet(PAGE_TITLE_STYLE)
        layout.addWidget(titre)

        lbl_section = QLabel("Suivi des versements de cantine par élève")
    ...
    def imprimer_clic(self):
        ...
        CantineStatPrinter.print_report(self, data, filtre)
