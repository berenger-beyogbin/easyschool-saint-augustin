...
class StatInscritsView(QWidget):
    ...
    def init_ui(self):
        ...
        titre = QLabel("Liste des Inscrits")
        titre.setStyleSheet(PAGE_TITLE_STYLE)
        layout.addWidget(titre)

        lbl_section = QLabel("État des inscrits")
    ...
    def refresh_data(self):
        ...
        data = StatistiquesService.get_inscrits(id_niveau, id_classe)
