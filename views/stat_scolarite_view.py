...
from utils.list_printer import ScolariteStatPrinter


class StatScolariteView(QWidget):
    ...
    def init_ui(self):
        ...
        titre = QLabel("État des Versements de Scolarité")
        titre.setStyleSheet(PAGE_TITLE_STYLE)
        layout.addWidget(titre)

        lbl_section = QLabel("Suivi des versements de scolarité par élève")
        ...
        self.table.setHorizontalHeaderLabels([
            ...
            "Montant dû", "Montant versé", "Réduction", "Reste", "État"
        ])
    ...
    def refresh_data(self):
        ...
        data = StatistiquesService.get_etat_versements_scolarite(id_niveau, id_classe)
    ...
    def imprimer_clic(self):
        ...
        ScolariteStatPrinter.print_report(self, data, filtre)
